...
public class UploadGamePictureWindow extends Window {
    ...
    private void setTarget(Game g) {
        ...
        pane = new HTMLPane();
        pane.setContents("<b>Upload an thumbnail image for game "+g.getString(GameModel.GAME_TITLE_FIELD)+"</b>");
        target.addMember(pane);
