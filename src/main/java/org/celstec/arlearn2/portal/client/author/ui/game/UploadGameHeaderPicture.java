...
public class UploadGameHeaderPicture  extends Window {
    ...
    private void setTarget(Game g) {
        ...
        pane = new HTMLPane();
        pane.setContents("<b>Upload an header image for game "+g.getString(GameModel.GAME_TITLE_FIELD)+"</b>");
        target.addMember(pane);
