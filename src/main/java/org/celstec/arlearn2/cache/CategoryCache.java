...
public class CategoryCache extends GenericCache {
    ...
    public void storeCategoriesLangGame(CategoryList bean, String lang, long gameId) {
        if (!bean.getCategoryList().isEmpty()){
            getCache().put(CATEGORY_PREFIX+":lang:"+lang+":gameId:"+gameId, bean);
        }
    }
    ...
    public CategoryList getCategoriesLangGame(String lang, Long gameId) {
        return (CategoryList) getCache().get(CATEGORY_PREFIX+":lang:"+lang+":gameId:"+gameId);
    }
