...
public class RunManager {
	...
	private static final String params[] = new String[] { "id", "gameId", "owner", "title", "tagId", "code" };
	private static final String paramsNames[] = new String[] { "runParam", "gameParam", "ownerEmailParam", "titleParam", "tagIdParam", "codeParam" };
	...
	public static List<RunJDO> getRuns(PersistenceManager pm, Long runId, Long gameId, String owner, String title, String tagId, String code) {
		Query query = pm.newQuery(RunJDO.class);
		Object args[] = { runId, gameId, owner, title, tagId, code };
	...
	public static List<Run> getRuns(Long runId, Long gameId, String owner, String title, String tagId, String code) {
		ArrayList<Run> returnRuns = new ArrayList<Run>();
		PersistenceManager pm = PMF.get().getPersistenceManager();
		try {
			Iterator<RunJDO> it = getRuns(pm, runId, gameId, owner, title, tagId, code).iterator();
			while (it.hasNext()) {
	...
	public static void deleteRun(Long runId) {
		PersistenceManager pm = PMF.get().getPersistenceManager();
		try {
			List<RunJDO> runsToDelete = getRuns(pm, runId, null, null, null, null, null);
	...
	public static void setStatusDeleted(long runId) {
		PersistenceManager pm = PMF.get().getPersistenceManager();
		try {
			List<RunJDO> deleteList = getRuns(pm, runId, null, null, null, null, null);
	...
	public static void updateRun(long runId, Run run) {
		...
		PersistenceManager pm = PMF.get().getPersistenceManager();
		try {
			List<RunJDO> updateList = getRuns(pm, runId, null, null, null, null, null);
