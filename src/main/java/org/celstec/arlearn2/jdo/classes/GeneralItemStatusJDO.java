...
@PersistenceCapable
public class GeneralItemStatusJDO extends GameClass {
    ...
    public Long getGeneralItemStatusId() {
        return id.getId();
    }

    public void setIdentifier(Long id) {
        if (id != null)
            this.id = KeyFactory.createKey(GeneralItemStatusJDO.class.getSimpleName(), id);
    }
