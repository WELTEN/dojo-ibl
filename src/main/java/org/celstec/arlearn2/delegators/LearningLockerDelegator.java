...
public class LearningLockerDelegator extends GoogleDelegator{
    protected static final Logger logger = Logger.getLogger(LearningLockerDelegator.class.getName());
    ...
    private static LearningLockerDelegator learningLockerDelegator;

//    public LearningLockerDelegator(GoogleDelegator gd) {
//        super(gd);
//    }

    public LearningLockerDelegator() {
        super();
    }
