angular.module("DojoIBL")
    ...
    .directive('draggable', ['$compile', function ($compile) {
        return {
            ...
            templateUrl: function (el, attrs) {
                return (angular.isDefined(attrs.template)) ? attrs.template : '/dist/templates/directives/draggable-default.html';
                //return "";
            },
    ...
    .directive('droppable', ['$compile', function ($compile) {
        return {
            ...
            scope: {},
            templateUrl: function (el, attrs) {
                return (angular.isDefined(attrs.template)) ? attrs.template : '/dist/templates/directives/droppable-default.html';
                //return "";
            },
            link: function (scope, el, attrs, ctrlr, transFn) {
                scope.obj = {
